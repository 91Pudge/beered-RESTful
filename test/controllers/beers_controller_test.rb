...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference("Beer.count") do
      post beers_url, params: { beer: { Brewery: @beer.Brewery, Description: @beer.Description, IBU: @beer.IBU, beer_name: @beer.beer_name } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { Brewery: @beer.Brewery, Description: @beer.Description, IBU: @beer.IBU, beer_name: @beer.beer_name } }
